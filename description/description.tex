...
% * Draw downs. Max 20%. Maximum drawdowns.
...
% - Sensitivity tests
% - Stress scenarios
% - Costs, slippage, regime shifts, order type, ...
% 
% Live:
% - Market or limit orders. Buy/sell long. Avoid short, or with stop limit?

% Risks:
% - Operational. Mitigation: keep tech simple
% - Faulty strategy. M1: Do excellent robust testing
%                    M2: Monitor
%                    M3: Review
%                    M4: Suitable order types
