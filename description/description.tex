...
\input{../src/strategies/generated_\strategy/constants.tex}
...
\newcommand{\figureTau}[1]{
    \begin{figure}[H]
        \begin{center}
            \includegraphics{../src/strategies/generated_\strategy/#1.png}
        \end{center}
...
\subsection{Entropy of Moments}

The Shannon entropy for discrete returns, volatility and skewness in the returns.
...
\begin{itemize}
    ...
    \item \url{https://stackoverflow.com/questions/15450192/fastest-way-to-compute-entropy-in-python}
    \item \url{https://www.linkedin.com/posts/lucas-inglese-75574817b_what-entropy-really-tells-you-about-a- time-activity-7401568412436561922-wO7K/}
\end{itemize}

\figureTau{entropy_moments}
